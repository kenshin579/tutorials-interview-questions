...
public class MinDepthTest {
    ...
    public void minDepth() {
        ...
        binaryTree.print();
        assertThat(new MinDepth().minDepth(binaryTree.getRoot())).isEqualTo(2);
    }
    ...
    public void minDepth4() {
        ...
        binaryTree.print();
        assertThat(new MinDepth().minDepth(binaryTree.getRoot())).isEqualTo(0);
    }
    ...
    public void minDepth5() {
        ...
        binaryTree.print();
        assertThat(new MinDepth().minDepth(binaryTree.getRoot())).isEqualTo(1);
    }
}